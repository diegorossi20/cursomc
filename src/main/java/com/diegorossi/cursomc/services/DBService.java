...
import com.diegorossi.cursomc.domain.Pagamento;
import com.diegorossi.cursomc.domain.PagamentoComBoleto;
import com.diegorossi.cursomc.domain.PagamentoComCartao;
...
import com.diegorossi.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		cat4.getProdutos().addAll(Arrays.asList(p2, p1, p3, p7));
		...
		Cliente cli1 = new Cliente(null, "Diego Rossi", "diegorossi20@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Maria Silva", "mariasilva@gmail.com", "60086420070",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("963852741", "998576235"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Rio Branco", "235", null, "Centro", cli2, c2);
